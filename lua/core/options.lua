...
-- Установка LF как окончания строк по умолчанию
vim.opt.fileformats = "unix"                         -- Приоритет LF при открытии файлов
vim.api.nvim_create_autocmd("BufWritePre", {
  pattern = "*",
  callback = function()
    vim.bo.fileformat = "unix"                       -- Форсировать LF при сохранении
  end,
})
