return {
  ...
  keys = {
    { '<leader>da', '<cmd>Trouble diagnostics toggle<cr>', desc = 'Диагностика (все файлы)' },
    { '<leader>db', '<cmd>Trouble diagnostics toggle filter.buf=0<cr>', desc = 'Диагностика (текущий буфер)' },
    { '<leader>ds', '<cmd>Trouble symbols toggle focus=false<cr>', desc = 'Символы' },
    { '<leader>dl', '<cmd>Trouble lsp toggle focus=false win.position=right<cr>', desc = 'LSP ссылки/определения' },
    { '<leader>dL', '<cmd>Trouble loclist toggle<cr>', desc = 'Список локаций' },
    { '<leader>df', '<cmd>Trouble qflist toggle<cr>', desc = 'Список исправлений' },
